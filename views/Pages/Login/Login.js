...
class Login extends Component {
    render() {
        return <div className="app flex-row align-items-center">
                <I18n ns="header">
                    {(t, { i18n }) => <header className="app-header pr-1">
                ...
                <Container>
                    <div className="app-content ml-0" style={{ minHeight: "unset" }}>
                        <I18n ns="login">
                            {(t, { i18n }) => <Row className="justify-content-center">
                                    <Col md="12" lg="10">
                                        <CardGroup>
                                            <LoginComponent userAuth={this.props.userAuth} />
                                            <Card className="d-none d-md-block text-white bg-primary py-5" style={{ width: 44 + "%" }}>
