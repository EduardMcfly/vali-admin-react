    ...
    if (props.error) {
        return (
            <div>
                ...
                <h5 className="text-center my-5 text-danger">{i18next.t('error')}</h5>
                <Button outline color="info mx-auto d-flex" onClick={props.retry}>
                    {i18next.t('refresh')}
                </Button>
            </div>
        );
...
const routes = {
    withoutAnimation: [{ path: '/farm', exact: true, name: 'farms', component: Farms }],
    animated: [
