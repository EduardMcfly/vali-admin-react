...
class DefaultAside extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            treeview: this.props.treeviewTab
        };
    ...
    componentDidUpdate() {
        this.treeviewShow(this.props.treeviewTab);
    }
    ...
    treeview(tab) {
        if (this.props.treeviewTab !== tab) {
            this.props.treeviewSet(tab);
        } else {
            this.props.treeviewSet(0);
        }
    }
    treeviewShow(tab) {
        if (this.props.treeviewTab !== tab) {
