...
class Sidebar extends Component {
    ...
    render() {
        ...
        return <aside className="app-sidebar">
                <AddFarm getlistFarms={this.getlistFarms} ref={farm => {
                        this.farmAdd = farm;
                    }} />
                <div className="user-info" />
                <div className="app-sidebarUser">
                    <div className="c-pointer">
                        <i className="fa fa-user-circle-o fa-3x mr-2 imgUserNavBar app-sidebarUser-avatar mx-auto" aria-hidden="true" />
                    </div>
                    <div className="c-pointer text-capitalize mx-2 text-truncate container">
                        ...
                        <div className="app-sidebarUser-designation" style={{ textDecorationLine: "overline", fontStyle: "italic" }}>
                ...
                <ul className="app-menu">
                    <li className={"treeview scroll is-expanded"} style={{ borderBottom: "3px solid rgb(0, 125, 113)" }}>
                        <div className="app-menuItem" data-toggle="treeview" style={{ borderLeftColor: "transparent", background: "rgba(0, 0, 0, 0.25)" }}>
                            ...
                            <div className="ml-4">
                                <i className="icon fa fa-refresh text-light fa-1x c-pointer" onClick={this.getlistFarms} />
                            </div>
                        </div>
                        <ul className="treeview-menu" style={{ maxHeight: "30vh", overflowY: "scroll" }}>
                            <li>
                                <div className="treeview-item c-pointer" onClick={() => {
